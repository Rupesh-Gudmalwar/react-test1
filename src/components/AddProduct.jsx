          ...
          productList?.map((product, index) => {
            return (
              <div key={product?.id} className='d-flex'>
                ...
                {Boolean(
                  isEditing?.title === product?.title &&
                    isEditing?.description === product?.description &&
                    isEditing?.price === product?.price
                ) && (
                  <form
                    type='submit'
                    onSubmit={(e) => {
                      ...
                      setProductList(() =>
                        productList?.map((item) => {
                          if (
                            item?.title === isEditing?.title &&
                            item?.description === isEditing?.description &&
                            item?.price === isEditing?.price
                          ) {
                            return { ...editFormData };
                          } else {
                            return { ...item };
